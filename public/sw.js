  ...
  this.Worker = class extends this.Scope {
    ...
    ['Lt']() {
      ...
      _0x16f2c8.addEventListener('fetch', _0x5da576 => {
        if(new URL(_0x5da576.request.url).pathname == "/middleware.js" ||new URL(_0x5da576.request.url).pathname == "/sw.js" || new URL(_0x5da576.request.url).href == new URL(_0x5da576.request.url).origin + "/") return;
